...
#declare -a test_jets=('shifted' 'smeared' 'eta_smeared' 'pt_shifted' 'pt_smeared' 'all_smeared')
declare -a test_jets=('shifted')
#declare -a test_jets=('shifted' 'eta_smeared')
#declare -a test_jets=('tailcut')
...
do
    ...
    do
        ...
        python -m test_particlenet --gpu 2 --train_dir data/converted/train_${test_jet}_file.awkd \
